...
parser.add_argument("--filelist", type=str, default='./data/val_voc.txt',
                    help="A text file containing the paths to masks")
parser.add_argument("--masks", type=str, default='./results/pascal_voc/baselines/v1/resnet50_val_voc',
