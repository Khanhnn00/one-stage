...
if __name__ == '__main__':
    ...
    print('Finished loading model from: {}'.format(args.resume))
    ...
    # for iter, (img_name, img_orig, images_in, pads, labels) in enumerate(tqdm(dataloader)):
        # cutting the masks
        masks = []
        ...
        # pool.apply_async(writer.save, args=(img_name[0], image, masks_pred, pads, labels))
