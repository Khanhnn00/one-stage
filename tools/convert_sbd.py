...
def args():
    ...
    parser.add_argument("--inp", type=str, default='/host/K2017/tiepnv/khanhnn/docker/dataset/benchmark_RELEASE/dataset/cls',
                        help="Directory with .mat files")
    parser.add_argument("--out", type=str, default='/host/K2017/tiepnv/khanhnn/docker/dataset/benchmark_RELEASE/dataset/clscls_png/',
